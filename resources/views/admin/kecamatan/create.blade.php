...
<body>
                ...
                <div class="form-card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" 
                                  class="form-control-custom" 
                                  placeholder="Masukkan alamat lengkap kantor kecamatan">{{ old('alamat') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" 
                                  class="form-control-custom" 
                                  rows="4"
                                  placeholder="Tuliskan deskripsi singkat tentang kecamatan ini">{{ old('deskripsi') }}</textarea>
    ...
    <div class="floating-buttons">
        <a href="{{ route('admin.kecamatan.index') }}" class="floating-btn primary" title="Kembali">
