                ...
                <form method="POST" action="{{ route('admin.desa.store') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_desa" class="form-control" value="{{ old('nama_desa') }}" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Kode Desa</label>
                            <input type="text" name="kode_desa" class="form-control" value="{{ old('kode_desa') }}" placeholder="Contoh: 3523010001">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kepala_desa" class="form-control" value="{{ old('kepala_desa') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_penduduk" class="form-control" value="{{ old('jumlah_penduduk', 0) }}" min="0">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Jumlah KK</label>
                            <input type="number" name="jumlah_kk" class="form-control" value="{{ old('jumlah_kk', 0) }}" min="0">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="luas_wilayah" class="form-control" value="{{ old('luas_wilayah') }}" min="0">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="action-buttons">
                        <a href="{{ route('admin.desa.index') }}" class="btn btn-back">Batal</a>
