...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* WARNA CARD */
        .menu-card.kecamatan { background: linear-gradient(135deg, #e0f2fe 0%, #bae6fd 100%); border-color: #1e88e5; }
        .menu-card.kecamatan .menu-icon { background: linear-gradient(135deg, #1e88e5, #0ea5e9); }
        .menu-card.kecamatan .menu-icon i { color: white; }
        .menu-card.kecamatan h5 { color: #0c4a6e; }
        .menu-card.kecamatan p { color: #0369a1; }
        
        .menu-card.desa { background: linear-gradient(135deg, #e0f2f1 0%, #b2dfdb 100%); border-color: #00897b; }
        .menu-card.desa .menu-icon { background: linear-gradient(135deg, #00897b, #00695c); }
        .menu-card.desa .menu-icon i { color: white; }
        .menu-card.desa h5 { color: #004d40; }
        .menu-card.desa p { color: #00695c; }
        
        .menu-card.wisata { background: linear-gradient(135deg, #fce7f3 0%, #fbcfe8 100%); border-color: #ec4899; }
        .menu-card.wisata .menu-icon { background: linear-gradient(135deg, #ec4899, #db2777); }
        .menu-card.wisata .menu-icon i { color: white; }
        .menu-card.wisata h5 { color: #831843; }
        .menu-card.wisata p { color: #9d174d; }
        
        .menu-card.pasar { background: linear-gradient(135deg, #dcfce7 0%, #bbf7d0 100%); border-color: #10b981; }
        .menu-card.pasar .menu-icon { background: linear-gradient(135deg, #10b981, #059669); }
        .menu-card.pasar .menu-icon i { color: white; }
        .menu-card.pasar h5 { color: #064e3b; }
        .menu-card.pasar p { color: #065f46; }
        
        .menu-card.kantor { background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border-color: #3b82f6; }
        .menu-card.kantor .menu-icon { background: linear-gradient(135deg, #3b82f6, #2563eb); }
        .menu-card.kantor .menu-icon i { color: white; }
        .menu-card.kantor h5 { color: #1e3a8a; }
        .menu-card.kantor p { color: #1e40af; }
        
        .menu-card.wifi { background: linear-gradient(135deg, #cffafe 0%, #a5f3fc 100%); border-color: #06b6d4; }
        .menu-card.wifi .menu-icon { background: linear-gradient(135deg, #06b6d4, #0891b2); }
        .menu-card.wifi .menu-icon i { color: white; }
        .menu-card.wifi h5 { color: #164e63; }
        .menu-card.wifi p { color: #155e75; }
        
        .menu-card.bumdes { background: linear-gradient(135deg, #ecfccb 0%, #d9f99d 100%); border-color: #84cc16; }
        .menu-card.bumdes .menu-icon { background: linear-gradient(135deg, #84cc16, #65a30d); }
        .menu-card.bumdes .menu-icon i { color: white; }
        .menu-card.bumdes h5 { color: #365314; }
        .menu-card.bumdes p { color: #3f6212; }
        
        .menu-card.kkdmp { background: linear-gradient(135deg, #e0e7ff 0%, #c7d2fe 100%); border-color: #6366f1; }
        .menu-card.kkdmp .menu-icon { background: linear-gradient(135deg, #6366f1, #4f46e5); }
        ...
        .menu-info p { font-size: 13px; margin: 0; line-height: 1.5; }
        
        .badge-utama {
            background: #1e88e5; color: white; font-size: 10px;
        ...
        .toolbar-btn {
            ...
            display: flex; align-items: center; justify-content: center;
            cursor: pointer; color: #6b7280; font-size: 22px;
            transition: all 0.3s; text-decoration: none; position: relative;
        }
        .toolbar-btn:hover {
            transform: translateX(-5px); color: #1e88e5;
            border-color: #1e88e5; box-shadow: 0 6px 20px rgba(30,136,229,0.2);
        }
        .toolbar-btn.primary {
        ...
        .toolbar-btn.primary:hover {
            ...
            box-shadow: 0 8px 25px rgba(30,136,229,0.3); color: white;
        }
        .toolbar-btn .tooltip-text {
            position: absolute; right: 70px; background: #1e3a8a;
            color: white; padding: 6px 12px; border-radius: 6px;
            font-size: 12px; font-weight: 600; white-space: nowrap;
            opacity: 0; visibility: hidden; transition: all 0.2s;
        }
        .toolbar-btn:hover .tooltip-text {
            opacity: 1; visibility: visible; right: 65px;
        }
...
<body>
    ...
    <header class="header">
        ...
        <!-- User Dropdown dengan Pengaturan -->
        <div class="dropdown">
            <div class="header-user dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu dropdown-menu-end custom-dropdown-menu">
                <li><h6 class="custom-dropdown-header">Menu Akun</h6></li>
                <li>
                ...
                <li><hr class="dropdown-divider custom-dropdown-divider"></li>
                <li>
                    <form action="#" method="POST">
                        @csrf
                        <button type="submit" class="dropdown-item custom-dropdown-item text-danger w-100 border-0 bg-transparent">
    ...
    <main class="main-content">
        ...
        <!-- Menu Grid - TANPA DUSUN DAN BERITA -->
        <div class="menu-grid">
            <!-- Kecamatan -->
    ...
    <!-- Floating Toolbar - TANPA EDIT BERITA -->
    <div class="floating-toolbar">
        <a href="#" class="toolbar-btn primary" title="Tambah Data Baru">
            <i class="bi bi-plus-lg"></i>
            <span class="tooltip-text">Tambah Data Baru</span>
        </a>
        <a href="#" class="toolbar-btn" title="Pengaturan Sistem">
            <i class="bi bi-gear"></i>
            <span class="tooltip-text">Pengaturan Sistem</span>
        </a>
