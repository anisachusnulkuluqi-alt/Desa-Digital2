...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .nav-menu a { color: #ffffff; text-decoration: none; font-size: 0.82rem; font-weight: 700; text-transform: uppercase; transition: opacity 0.2s; }
...
<body>
    ...
    <header class="site-header">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="<?= url('/surat'); ?>">Surat Desa</a></li>
