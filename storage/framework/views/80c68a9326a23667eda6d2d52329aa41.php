...
<body>
    ...
    <nav class="main-navbar">
        <a href="<?php echo e(url('/')); ?>" class="navbar-brand-link">
            <img src="<?php echo e(asset('images/desa-digital.png')); ?>" 
                 alt="Logo Desa Digital" 
                 class="brand-logo-img"
                 onerror="this.onerror=null; this.src='<?php echo e(asset('images/desa-digital.png')); ?>'; this.onerror=function(){ this.style.display='none'; document.getElementById('altLogoText').style.display='inline'; };">
        ...
        <div class="navbar-nav-cluster">
            <ul class="nav-links-menu">
                ...
                <li><a href="<?php echo e(url('/data-spasial')); ?>">Peta Spasial</a></li>
                <li><a href="#lokasi-kami">Hubungi Kami</a></li>
            </ul>

            <form class="search-pill-nav" action="<?php echo e(url('/desa')); ?>" method="GET">
    ...
    <!-- 2. HERO BANNER -->
    <section id="hero-banner" class="hero-banner-clean" style="background-image: url('<?php echo e(asset('images/alun-alun-tuban.jpg')); ?>');">
        <div class="hero-content-wrap">
            ...
            <a href="<?php echo e(url('/data-spasial')); ?>" class="btn-hero-primary">
    ...
    <section id="statistik-wilayah" class="section-stats-bright">
        ...
        <div class="stats-cards-grid">
            ...
            <a href="<?php echo e(url('/data-spasial?filter=wifi')); ?>" class="stat-card-modern" style="--stat-accent: #0284c7; --stat-bg: #e0f2fe;">
                <div>
            ...
            <!-- 2. Website Desa -->
            <a href="<?php echo e(url('/desa')); ?>" class="stat-card-modern" style="--stat-accent: #2563eb; --stat-bg: #dbeafe;">
                <div>
                    <div class="stat-card-header">
            ...
            <a href="<?php echo e(url('/data-spasial?filter=wisata')); ?>" class="stat-card-modern" style="--stat-accent: #10b981; --stat-bg: #d1fae5;">
                <div>
                    <div class="stat-card-header">
            ...
            <a href="<?php echo e(url('/data-spasial?filter=kantor')); ?>" class="stat-card-modern" style="--stat-accent: #4f46e5; --stat-bg: #e0e7ff;">
                <div>
                    <div class="stat-card-header">
            ...
            <a href="<?php echo e(url('/data-spasial?filter=pasar')); ?>" class="stat-card-modern" style="--stat-accent: #f59e0b; --stat-bg: #fef3c7;">
                <div>
                    <div class="stat-card-header">
            ...
            <!-- 6. BUMDes -->
            <a href="<?php echo e(url('/data-spasial?filter=bumdes')); ?>" class="stat-card-modern" style="--stat-accent: #8b5cf6; --stat-bg: #ede9fe;">
                <div>
                    <div class="stat-card-header">
            ...
            <!-- 7. KKDMP -->
            <a href="<?php echo e(url('/desa')); ?>" class="stat-card-modern" style="--stat-accent: #f43f5e; --stat-bg: #ffe4e6;">
                <div>
                    <div class="stat-card-header">
            ...
            <!-- 8. Distrik Kecamatan -->
            <a href="<?php echo e(url('/kecamatan')); ?>" class="stat-card-modern" style="--stat-accent: #0d9488; --stat-bg: #ccfbf1;">
                <div>
                    <div class="stat-card-header">
    ...
    <section id="layanan-digital" class="section-services-clean">
        ...
        <div class="services-cards-cluster">
            ...
            <!-- 1. Website Desa -->
        <a href="<?php echo e(url('/website')); ?>" class="service-card-clean" title="Buka Direktori Website Desa">
    ...
    <p>Katalog profil kelurahan dan informasi publik desa.</p>
            ...
            <a href="<?php echo e(url('/data-spasial')); ?>" class="service-card-clean highlight-card" title="Klik untuk membuka Geoportal Peta Spasial">
            ...
            <!-- 3. Surat Desa -->
<a href="<?php echo e(url('/surat')); ?>" class="service-card-clean" title="Pengajuan Surat Mandiri Desa">
    ...
    <p>Permohonan SKU, domisili, dan surat mandiri.</p>
           ...
           <!-- 4. CCTV -->
<a href="<?php echo e(url('/cctv')); ?>" class="service-card-clean" title="Pantauan Live CCTV Wilayah">
    ...
    <p>Pantau titik keramaian dan keamanan wilayah Tuban.</p>
          ...
          <!-- 5. e-PBB -->
<a href="<?php echo e(url('/epbb')); ?>" class="service-card-clean" title="Layanan Pajak PBB-P2 Online">
