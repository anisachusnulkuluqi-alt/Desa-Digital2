    ...
    <div class="main-content">
        ...
        <div class="form-card">
            ...
            <div class="card-body-modern">
                <form method="POST" action="<?php echo e(route('admin.desa.update', $desa->id)); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="nama_desa" 
                                   class="form-control" 
                                   value="<?php echo e(old('nama_desa', $desa->nama_desa)); ?>" 
                                   required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="kode_desa" 
                                   class="form-control" 
                                   value="<?php echo e(old('kode_desa', $desa->kode_desa)); ?>"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="kecamatan_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $kecamatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kec->id); ?>" 
                                            <?php echo e(old('kecamatan_id', $desa->kecamatan_id) == $kec->id ? 'selected' : ''); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="kepala_desa" 
                                   class="form-control" 
                                   value="<?php echo e(old('kepala_desa', $desa->kepala_desa)); ?>"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   class="form-control" 
                                   value="<?php echo e(old('jumlah_penduduk', $desa->jumlah_penduduk)); ?>" 
                                   min="0"
                                   placeholder="0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   name="jumlah_kk" 
                                   class="form-control" 
                                   value="<?php echo e(old('jumlah_kk', $desa->jumlah_kk)); ?>" 
                                   min="0"
                                   placeholder="0">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="telepon" 
                                   class="form-control" 
                                   value="<?php echo e(old('telepon', $desa->telepon)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" 
                                   name="email" 
                                   class="form-control" 
                                   value="<?php echo e(old('email', $desa->email)); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" 
                                  class="form-control" 
                                  rows="4"
                                  placeholder="Alamat lengkap kantor desa"><?php echo e(old('alamat', $desa->alamat)); ?></textarea>
                        <div class="form-hint">Alamat lengkap kantor desa</div>
                    </div>
                    
                    <div class="action-buttons">
                        <a href="<?php echo e(route('admin.desa.index')); ?>" class="btn btn-secondary">
...
</html><?php /**PATH C:\Users\DELL\Desa-Digital2\resources\views/admin/desa/edit.blade.php ENDPATH**/ ?>