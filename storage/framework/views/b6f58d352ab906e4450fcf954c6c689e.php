    ...
    <div class="main-content">
        <div class="page-header">
            <div class="page-title">
                <h1><i class="bi bi-geo-alt-fill"></i> Detail Desa <?php echo e($desa->nama_desa); ?></h1>
                <p>Informasi lengkap desa <?php echo e($desa->nama_desa); ?></p>
            </div>
            <div class="action-buttons">
                <a href="<?php echo e(route('admin.desa.index')); ?>" class="btn btn-back">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
                <a href="<?php echo e(route('admin.desa.edit', $desa->id)); ?>" class="btn btn-edit">
            ...
            <div class="card-body-modern">
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo e($desa->nama_desa); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-geo-alt"></i> Kode Desa</div>
                        <div class="info-value"><?php echo e($desa->kode_desa ?? '-'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-map"></i> Kecamatan</div>
                        <div class="info-value"><?php echo e($desa->kecamatan->nama_kecamatan ?? '-'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-person"></i> Kepala Desa</div>
                        <div class="info-value <?php echo e(!$desa->kepala_desa ? 'empty' : ''); ?>"><?php echo e($desa->kepala_desa ?? 'Belum diisi'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-people"></i> Jumlah Penduduk</div>
                        <div class="info-value"><?php echo e(number_format($desa->jumlah_penduduk ?? 0)); ?> Jiwa</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-house-heart"></i> Jumlah KK</div>
                        <div class="info-value"><?php echo e(number_format($desa->jumlah_kk ?? 0)); ?> KK</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-rulers"></i> Luas Wilayah</div>
                        <div class="info-value"><?php echo e($desa->luas_wilayah ?? '-'); ?> km²</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-telephone"></i> Telepon</div>
                        <div class="info-value <?php echo e(!$desa->telepon ? 'empty' : ''); ?>"><?php echo e($desa->telepon ?? 'Belum diisi'); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="bi bi-envelope"></i> Email</div>
                        <div class="info-value <?php echo e(!$desa->email ? 'empty' : ''); ?>"><?php echo e($desa->email ?? 'Belum diisi'); ?></div>
                    </div>
                    <div class="info-item full">
                        <div class="info-label"><i class="bi bi-pin-map"></i> Alamat</div>
                        <div class="info-value <?php echo e(!$desa->alamat ? 'empty' : ''); ?>"><?php echo e($desa->alamat ?? 'Belum diisi'); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\DELL\Desa-Digital2\resources\views/admin/desa/show.blade.php ENDPATH**/ ?>