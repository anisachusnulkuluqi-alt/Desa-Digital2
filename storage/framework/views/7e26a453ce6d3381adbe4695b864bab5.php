    ...
    <div class="main-content">
        ...
        <div class="info-card">
            ...
            <p class="info-card-text mb-0">
                Anda sedang mengedit data kecamatan <strong><?php echo e($kecamatan->nama_kecamatan); ?></strong>. 
        ...
        <div class="form-card">
            ...
            <form action="<?php echo e(route('admin.kecamatan.update', $kecamatan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e(old('nama_kecamatan', $kecamatan->nama_kecamatan)); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="kode_wilayah" 
                                   class="form-control-custom" 
                                   value="<?php echo e(old('kode_wilayah', $kecamatan->kode_wilayah)); ?>" 
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="kabupaten" 
                                   class="form-control-custom" 
                                   value="<?php echo e(old('kabupaten', $kecamatan->kabupaten ?? 'Tuban')); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   name="jumlah_desa" 
                                   class="form-control-custom" 
                                   value="<?php echo e(old('jumlah_desa', $kecamatan->jumlah_desa ?? 0)); ?>" 
                                   placeholder="0"
                                   min="0">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="telepon" 
                                   class="form-control-custom" 
                                   value="<?php echo e(old('telepon', $kecamatan->telepon)); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" 
                                   name="email" 
                                   class="form-control-custom" 
                                   value="<?php echo e(old('email', $kecamatan->email)); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" 
                                  class="form-control-custom" 
                                  placeholder="Masukkan alamat lengkap kantor kecamatan"><?php echo e(old('alamat', $kecamatan->alamat)); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" 
                                  class="form-control-custom" 
                                  rows="4"
                                  placeholder="Tuliskan deskripsi singkat tentang kecamatan ini"><?php echo e(old('deskripsi', $kecamatan->deskripsi)); ?></textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <p class="text-muted mb-3">
                    ...
                    Setelah dihapus, data kecamatan <strong><?php echo e($kecamatan->nama_kecamatan); ?></strong> tidak dapat dikembalikan.
                </p>
                
                <form action="<?php echo e(route('admin.kecamatan.destroy', $kecamatan->id)); ?>" method="POST" onsubmit="return confirm('⚠️ PERINGATAN!\n\nYakin ingin menghapus kecamatan <?php echo e($kecamatan->nama_kecamatan); ?>?\n\nData yang sudah dihapus TIDAK BISA dikembalikan!')">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\DELL\Desa-Digital2\resources\views/admin/kecamatan/edit.blade.php ENDPATH**/ ?>