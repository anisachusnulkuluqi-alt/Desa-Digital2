...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('dashboard')); ?>" class="active"><i class="bi bi-house-fill"></i><span>Beranda</span></a></li>
            ...
            <li><a href="<?php echo e(route('admin.pasar.index')); ?>"><i class="bi bi-shop"></i><span>Pasar Desa</span></a></li>
            <li><a href="<?php echo e(route('admin.kantor.index')); ?>"><i class="bi bi-building"></i><span>Kantor Desa</span></a></li>
            <li><a href="<?php echo e(route('admin.wifi.index')); ?>"><i class="bi bi-wifi"></i><span>WiFi Desa</span></a></li>
            <li><a href="<?php echo e(route('admin.bumdes.index')); ?>"><i class="bi bi-briefcase-fill"></i><span>BUMDes</span></a></li>
            <li><a href="<?php echo e(route('admin.kkdmp.index')); ?>"><i class="bi bi-people-fill"></i><span>KKDMP</span></a></li>
        </ul>
    </aside>
